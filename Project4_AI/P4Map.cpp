...
P4Map::P4Map(int mapColumns, int mapRows, unsigned int *levelData,
...
P4Map::~P4Map() { UnloadTexture(mTextureAtlas); }
...
bool P4Map::isSolidTileAt(Vector2 position, float *xOverlap, float *yOverlap)
{
    *xOverlap = 0.0f;
    *yOverlap = 0.0f;
