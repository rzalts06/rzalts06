...
void Level1::initialise() {
    ...
    mGameState.bg = LoadMusicStream("Project4_AI/Audio/Let'sGetCrazy.wav");
    ...
    mGameState.cheese[0].setPosition({360.0f, 285.0f});
    mGameState.cheese[1].setPosition({605.0f, 640.0f});
    mGameState.cheese[2].setPosition({1075.0f, 635.0f});
...
void Level1::update(float deltaTime) {
    ...
    mGameState.hannah->update(
        ...
        mGameState.paps->update(deltaTime, nullptr, mGameState.stages,
             nullptr, 0, 100.0f, 850.0f, nullptr);
