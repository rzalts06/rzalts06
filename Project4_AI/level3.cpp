...
void Level3::initialise() {
    ...
    mGameState.bg = LoadMusicStream("Project4_AI/Audio/OrdinaryGirl.wav");
    ...
    mGameState.cheese[0].setPosition({360.0f, 650.0f});
    mGameState.cheese[1].setPosition({720.0f, 290.0f});
    mGameState.cheese[2].setPosition({1080.0f, 755.0f});
...
void Level3::update(float deltaTime) {
    ...
    mGameState.hannah->update(
        ...
        mGameState.paps->update(deltaTime, nullptr, mGameState.stages,
             nullptr, 0, 780.0f, 1260.0f, nullptr);
